...
Focus on creating production-ready, well-documented code that follows Flutter best practices.""",
    ...
    async def execute_llm_task(self, prompt: str) -> Dict[str, Any]:
        ...
        try:
            ...
            As the Flutter Data Agent, provide a complete, production-ready data solution.
            ...
            logger.error(f"Data LLM task execution failed: {e}")
            return {"content": f"Error generating content: {e}", "success": False}


def create_flutter_data_agent(progress_board=None):
    """Factory function to create Flutter Data Agent."""

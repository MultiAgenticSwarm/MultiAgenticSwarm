...
from multiagenticswarm import Agent, System, Task, Tool
...
class TestAgent:
    ...
    async def test_agent_execution(self):
        ...
        with patch(
            ...
            agent = Agent(
                name="ExecutionTest", system_prompt="You are a helpful assistant"
            )

            result = await agent.execute(
                "Hello, how are you?", tool_executor=tool_executor
            )
...
class TestTool:
    ...
    def test_tool_creation(self):
        ...
        tool = Tool(name="TestTool", func=sample_func, description="A test tool")
...
class TestTask:
    ...
    def test_task_creation(self):
        ...
        task = Task(name="TestTask", description="A test task")
    ...
    async def test_system_execution(self):
        ...
        with patch(
            ...
            result = await system.execute_agent(
                "ExecutionAgent", "Hello world", {"test": True}
            )
